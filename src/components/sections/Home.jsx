...
>
          ...
          <p className="text-gray-700 text-base md:text-base font-cantata">
              My interests include <span className="font-bold text-black">FPGA development</span>, <span className="font-bold text-black">digital design</span>, and
              <span className="font-bold text-black"> machine learning</span>. I recently wrapped up a summer internship at the 
              ...
              <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-indigo-800 font-bold hover:underline underline-offset-4"
              >
